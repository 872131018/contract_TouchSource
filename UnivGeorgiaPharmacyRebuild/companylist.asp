...
<TR>
	...
	<TD align="center" valign="middle" class="setOne2"><div class="listLarge"><%response.write (Companies("Building"))%></div></td>
	<TD align="center" valign="middle" class="setOne3"><div class="listLarge"><%response.write (Companies("Suite"))%></div></td>
	<TD align="center" valign="middle" class="setOne4">
    <div class="listLarge">

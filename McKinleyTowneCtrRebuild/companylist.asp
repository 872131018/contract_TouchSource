...
IF Companies.recordcount = 0 THEN%>
		<tr>
				<TD colspan="5" height="50"><div class="listLarge">&nbsp;&nbsp;<% IF (CompCount.recordcount = 0) AND (request.querystring("letter") = "") THEN%>There are no listings at this time.<%ELSE%>There are no listings that start with "<%response.write (request.querystring("letter"))%>".<%END IF%></div></TD>
		</TR>
<%
ELSE
%>
...
<TR>
	<TD align="left" valign="middle" class="setOne0">
		<div class="listLarge">
	...
	<TD align="center" valign="middle" class="setOne3"><div class="listLarge"><%response.write (Companies("Floor"))%></div></td>

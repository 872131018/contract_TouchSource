...
if(!window.jQuery) 
{
  ...
  */
  map_url = 'http://updates.touchsource.com'+window.location.pathname+window.location.search;
  /*
...
<div id="qrcode" style="position: absolute; top: 1040px; left: 30px;"></div>
<script>
/*
 * QR config section
*/

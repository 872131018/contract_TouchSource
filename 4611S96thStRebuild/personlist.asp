...
<tr>
	...
	<%
		DIM floor : suite = Names("suite")
		char1 = Left(suite,1)
		IF char1 <> "3" THEN %>
			<a href="indivanimatedmap.asp?ID=<%response.write(Names("IndID"))%>" target="_top"><img src="btn_map.jpg" border="0"></a>
		<% END IF %>
	</td>
	...
	<td align="center" valign="top" class="setTwo4"><div class="listMed"><%response.write (Names("floor"))%></div></td>
	<td align="center" valign="top" class="setTwo5"><div class="listMed"><%response.write (Names("phone"))%></div></td>
</tr>

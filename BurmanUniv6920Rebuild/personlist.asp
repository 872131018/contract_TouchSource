...
<!-- Check to see if there is a jpg or pdf, set href to point to those pages, otherwise, it goes to the detail page via the link icon. -->
	...
	<td align="center" valign="top" class="setTwo2"><div class="listMed"><%response.write (Names("Suite"))%></div></td>
	<td align="center" valign="top" class="setTwo3"><div class="listMed"><%response.write (Names("ibuilding"))%></div></td>

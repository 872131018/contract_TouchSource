...
<div class="listXS">&nbsp;</div>
	...
	<%
	StrSQLQuery = "SELECT *	FROM List12  WHERE Text2 = 'C'  ORDER BY Text1 ASC"
...
<TR>
	<TD align="center" valign="middle" class="setSix0"><a href="list12animatedmap.asp?ID=<%response.write(List12List("ID"))%>" target="_top"><img src="btn_map.jpg" border="0"></a></td>
	<TD align="left" valign="middle" class="setSix1"><div class="listMed"><%response.write (List12List("Text1"))%></div></td>
	<TD align="left" valign="middle" class="setSix2"><div class="listMed"><%response.write (List12List("Text3"))%></div></td>
	<TD align="left" valign="middle" class="setSix3"><div class="listMed"><%response.write (List12List("Text7"))%></div></td>
	<TD align="left" valign="middle" class="setSix4"><div class="listMed"><%response.write (List12List("Text4"))%></div></TD>
	<TD align="center" valign="top" class="setSix5"><div class="listMed"></div></TD>
</tr>

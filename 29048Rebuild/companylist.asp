...
<body background="bg_list3.jpg" bgproperties="fixed" leftmargin="0" topmargin="0" class="listingsWidth">
...
<tr>
	...
	<td align="center" valign="top" class="setOne3"><div class="listLarge"><%response.write (qCompanies("Building"))%></div></td>
